...
{{/*
Sets the name of the music PVC
*/}}
{{- define "navidrome.musicPVCName" -}}
{{- if .Values.persistence.music.pvc.existingClaim -}}
{{ .Values.persistence.music.pvc.existingClaim }}
{{- else -}}
{{ include "navidrome.fullname" . }}-music
{{- end -}}
{{- end -}}
...
{{- else -}}
{{ include "navidrome.fullname" . }}-data
{{- end -}}
{{- end -}}
